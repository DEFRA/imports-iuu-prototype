...
module.exports = [
  ...
  },
  {
    ...
    arrivalTime: '',
    port: 'Grimsby',
    containerNumber: 'MSCU1000030',
    vesselName: 'Multiple vessels',
    commodityCodes: ['030343'],
    species: 'Skipjack Tuna (Katsuwonus pelamis)',
    declaredWeightKg: 360000,
    catchCertificateCount: 4,
    processingStatementCount: 1,
    nmdCount: 0,
    additionalDocumentCount: 0,
    status: 'REQUIRES_DOCUMENT_CHECK',
    riskFlags: ['WEIGHT_MISMATCH', 'MISSING_EVIDENCE'],
    riskNotes: '1 catch certificate not accounted for',
    warningText: 'Possible discrepancy detected: 4 catch certificates were supplied but only 3 are referenced on the attached processing statement. Catch certificate SYC/SFA/10/2026-SW0454 (64,000 kg) is not represented in the processing evidence.',
    assessmentSummary: 'The commodity, species and product code information supplied within the notification is consistent with the supporting documentary evidence. However, one Catch Certificate supplied by the importer is not referenced within the Processing Statement. This means that 64,000 kg of certified catch cannot currently be linked to the processing activity described in the accompanying documentation. Additional information should be requested from the importer to determine whether an updated Processing Statement or further supporting evidence exists for Catch Certificate SYC/SFA/10/2026-SW0454.'
  },
  {
